...
//	}
	...
	public Vector2 lerp (Vector2 target, float alpha) {
        ...
        public static Double[] addPolars(Double distance1, Double angle1, Double distance2, Double angle2){
            /*PolarCoordinates pc1 = new PolarCoordinates(m.getDistance(), m.getAngle());
            PolarCoordinates pc2 = new PolarCoordinates(Double.parseDouble(m.getContent()[0]), Double.parseDouble(m.getContent()[1]));*/
