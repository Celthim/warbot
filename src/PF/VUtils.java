...
public class VUtils {
	...
	public static boolean containVector(Stack<Vector2> list, Vector2 v) {
        ...
        public static void Fier(WarBrain agent) {
            double rand = random() * 10;
            int val = (int) Math.floor(rand);
            
            switch(val){
                case 0 : agent.setDebugStringColor(Color.YELLOW);
                break;
                case 1 : agent.setDebugStringColor(Color.BLUE);
                break;
                case 2 : agent.setDebugStringColor(Color.CYAN);
                break;
                case 3 : agent.setDebugStringColor(Color.DARK_GRAY);
                break;
                case 4 : agent.setDebugStringColor(Color.GRAY);
                break;
                case 5 : agent.setDebugStringColor(Color.GREEN);
                break;
                case 6 : agent.setDebugStringColor(Color.MAGENTA);
                break;
                case 7 : agent.setDebugStringColor(Color.ORANGE);
                break;
                case 8 : agent.setDebugStringColor(Color.PINK);
                break;
                case 9 : agent.setDebugStringColor(Color.RED);
                break;
                default : agent.setDebugStringColor(Color.BLACK);
